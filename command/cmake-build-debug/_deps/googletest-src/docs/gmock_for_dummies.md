...
pointer, and you'll parse corrupted program states like memory leaks.)
...
4.  Exercise some code that uses the mocks; optionally, check the result using
    ...
    wrong arguments, you'll parse an error immediately.
...
when you allocate mocks on the heap. You parse that automatically if you use the
...
parse an upper-bound-violated failure. Here's an example:
